...
\end{align}
Multiplying with vector $\myvec{1 & 0 & 0}$ both sides,
\begin{align}
    \myvec{1 & 0 & 0}\vec{P}-&\myvec{1 & 0 & 0}\vec{A}=\nonumber \\
    &k\myvec{1 & 0 & 0}\vec{B}-k\myvec{1 & 0 & 0}\vec{P}
\end{align}
Using \eqref{eq-1}
\begin{align}
    0-\myvec{1 & 0 & 0}\vec{A}&=k\myvec{1 & 0 & 0}\vec{B}-0\\
    \implies -\myvec{1 & 0 & 0}\myvec{4\\8\\10}&=k\myvec{1 & 0 & 0}\myvec{6\\10\\-8}
\end{align}
\begin{align}
    \implies& -4 = 6k\\
    \implies& k = -2/3 
